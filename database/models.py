...
class DyCreator(Base):
    ...
    follows = Column(BigInteger, default=0, comment='关注数')
    fans = Column(BigInteger, default=0, comment='粉丝数')
    interaction = Column(BigInteger, default=0, comment='互动数')
...
class XhsNote(Base):
    ...
    liked_count = Column(BigInteger, default=0, comment='点赞数')
    collected_count = Column(BigInteger, default=0, comment='收藏数')
