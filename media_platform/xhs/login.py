...
class XiaoHongShuLogin(AbstractLogin):
    ...
    async def login_by_mobile(self):
        ...
        try:
            ...
            raise LoginError("Mobile login failed: verification code expired or login timed out")
    ...
    async def login_by_qrcode(self):
        ...
        if not base64_qrcode_img:
            ...
            if not base64_qrcode_img:
                raise LoginError("QR code login failed: could not find QR code image after clicking login button")
        ...
        try:
            ...
            raise LoginError("QR code login failed: scan timed out")
